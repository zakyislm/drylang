...
Head over to the [Installation](/docs/getting-started/installation) guide, or check out the [Basics](/docs/basics/variables) to see the madness in action. You can navigate through every feature on the sidebar!
